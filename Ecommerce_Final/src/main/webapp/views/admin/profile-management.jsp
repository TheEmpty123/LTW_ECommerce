                        ...
                        <div class="form-container">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="fullName" name="fullName" placeholder="The Empty" required>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="email" id="email" name="email" placeholder="emptythe.56@gmail.com"
                                           required>
                                </div>
                                <div class="form-group">
                                    <label for="phone">Phone No.</label>
                                    <input type="tel" id="phone" name="phone" placeholder="01864977437" required>
                                </div>
