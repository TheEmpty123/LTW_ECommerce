            ...
            <section class="recent">
                <div class="activity-grid-alt2">
                    <div class="activity-card">
                        ...
                        <div class="pagination">
                            <h6 class="show-entries">*Showing 1 to 10 of 16 entries</h6>
                                <a href="#">&laquo;</a>
